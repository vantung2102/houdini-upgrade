...
// License: LGPL-3.0-or-later
var jQuery = __webpack_require__(315);
...
var Stripe = function () {
    ...
    _createClass(Stripe, [{
        ...
        value: function setPublishableKey(key) {
...
var TokenizerWrapper = function () {
    function TokenizerWrapper(inner_field_name, key) {
        _classCallCheck(this, TokenizerWrapper);

        this.inner_field_name = inner_field_name;
        this.key = key;
    }

    _createClass(TokenizerWrapper, [{
        key: 'createToken',
        value: function createToken(outer_obj, callback) {
            var self = this;
